...
describe('Validation', () => {
    it('should validate proofs correctly', async () => {
        ...
        } as any, hashRequirements[0])).isVerified).toEqual(true);
        ...
        } as any, { providerId: 'dontcareintest', providerVersion: '1.0.0', allowedTags: [] })).isVerified).toEqual(true);
    });
    ...
    it('should validate invalid proofs and return false', async () => {
        ...
        } as any, hashRequirements[0])).isVerified).toEqual(false);
        ...
        } as any, { providerId: 'dontcareintest', providerVersion: '1.0.0', allowedTags: [] })).isVerified).toEqual(false);
    });
