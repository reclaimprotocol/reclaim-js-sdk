...
describe('Request', () => {
    it('should verify proofs correctly', async () => {
        ...
        } as any, { allowedExtraHashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] })).toEqual(true);
        ...
        } as any, { allowedExtraHashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] })).toEqual(false);
    ...
    it('should reject proof without parameters or providerHash', async () => {
        ...
        } as any, { allowedExtraHashes: ["0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470"] })).toEqual(false);
    });
    ...
    it('should reject proof which do not match hash', async () => {
        ...
        } as any, { allowedExtraHashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5e"] })).toEqual(false);
        ...
        } as any, { requiredHashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5e"] })).toEqual(false);
        ...
        } as any, { requiredHashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] })).toEqual(true);
