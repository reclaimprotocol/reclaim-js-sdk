...
describe('Request', () => {
    it('should verify proofs correctly', async () => {
        ...
        } as any, { hashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] })).isVerified).toEqual(true);
        ...
        } as any, { hashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] })).isVerified).toEqual(false);
    ...
    it('should reject proof without parameters or providerHash', async () => {
        ...
        } as any, { hashes: ["0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470"] })).isVerified).toEqual(false);
    ...
    it('should reject proof which do not match hash', async () => {
        ...
        } as any, { hashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5e"] })).isVerified).toEqual(false);
        ...
        } as any, { hashes: [""] })).isVerified).toEqual(false);
    });
    ...
    it('should return extracted data on successful verification', async () => {
        ...
        const result = await verifyProof({
            ...
            "witnesses": [
                { "id": "0x244897572368eadf65bfbc5aec98d8e5443a9072", "url": "wss://attestor.reclaimprotocol.org:444/ws" }
            ],
            "signatures": [
                "0x561d209c999536ad0c6b5834bb5416963a3d61b3045e621d99ba5e0a07aa1a7b0707a4e8f4a218c5dd13f9e470d3c7023b7ddeda5463069eb08c231dbb0ab63c1b"
            ]
        } as any, { hashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] });
    ...
    it('should return data for each proof on multiple proofs', async () => {
        globalThis.fetch = mockFetch({
            "data": [
                { "address": "0x1be31a94361a391bbafb2a4ccd704f57dc04d4bb" },
                { "address": "0x244897572368eadf65bfbc5aec98d8e5443a9072" }
        ...
        const result = await verifyProof([proof, proof], { hashes: ["0x4c20776ae89ab7eead49e4e393f4e07348a4d85e21869201aa6eea6e2bc07f5b"] });
        ...
        expect(result.data[0].context.contextAddress).toEqual('0x0');
        expect(result.data[1].context.contextAddress).toEqual('0x0');
    });
});
