...
describe('verifyProof', () => {
    ...
    it('fails TEE verification when timestamps diverge', async () => {
        const proof = proofData[0] as Proof;
    ...
    it('fails TEE verification when digests are tampered', async () => {
        const proof = proofData[0] as Proof;
        ...
        console.log({ flippedHex, originalHex });
